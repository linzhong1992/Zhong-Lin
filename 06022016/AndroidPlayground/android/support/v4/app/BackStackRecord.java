  ...
  implements FragmentManager.BackStackEntry, Runnable
{
  ...
  private boolean configureTransitions(int paramInt, TransitionState paramTransitionState, boolean paramBoolean, SparseArray<Fragment> paramSparseArray1, SparseArray<Fragment> paramSparseArray2)
  {
    ...
    for (bool = ((Fragment)localObject3).getAllowReturnTransitionOverlap();; bool = ((Fragment)localObject3).getAllowEnterTransitionOverlap())
    {
      ...
      if (localObject3 != null)
      {
        FragmentTransitionCompat21.addTransitionTargets(localObject4, paramSparseArray2, localViewGroup, (FragmentTransitionCompat21.ViewRetriever)localObject5, paramTransitionState.nonExistentView, paramTransitionState.enteringEpicenterView, paramTransitionState.nameOverrides, (ArrayList)localObject6, paramSparseArray1, localArrayMap, localArrayList);
...
/* Location:              C:\playground\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\app\BackStackRecord.class
