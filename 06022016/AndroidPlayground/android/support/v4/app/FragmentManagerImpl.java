  ...
  implements LayoutInflaterFactory
{
      ...
      if (paramParcelable.mActive != null)
      {
        ...
        if (paramList != null)
        {
          ...
          while (i < paramList.size())
          {
            ...
            {
              ((FragmentState)localObject2).mSavedFragmentState.setClassLoader(this.mHost.getContext().getClassLoader());
        ...
        if (i < paramParcelable.mActive.length)
        {
          ...
          if (localObject1 != null)
          {
            localObject2 = ((FragmentState)localObject1).instantiate(this.mHost, this.mParent);
            if (DEBUG) {
  ...
  public void setBackStackIndex(int paramInt, BackStackRecord paramBackStackRecord)
  {
    ...
    //   17: putfield 399	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   20: aload_0
    //   21: getfield 399	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   24: invokevirtual 397	java/util/ArrayList:size	()I
    //   27: istore 4
    //   29: iload 4
    //   31: istore_3
    //   32: iload_1
    ...
    //   41: ifeq +39 -> 80
    //   44: ldc 54
    //   46: new 167	java/lang/StringBuilder
    //   49: dup
    //   50: invokespecial 168	java/lang/StringBuilder:<init>	()V
    //   53: ldc_w 401
    //   56: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   59: iload_1
    //   60: invokevirtual 404	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   63: ldc_w 406
    //   66: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   69: aload_2
    //   70: invokevirtual 355	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   73: invokevirtual 178	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   76: invokestatic 358	android/util/Log:v	(Ljava/lang/String;Ljava/lang/String;)I
    //   79: pop
    //   80: aload_0
    //   81: getfield 399	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   84: iload_1
    //   85: aload_2
    //   86: invokevirtual 422	java/util/ArrayList:set	(ILjava/lang/Object;)Ljava/lang/Object;
    //   89: pop
    //   90: aload_0
    //   91: monitorexit
    //   92: return
    ...
    //   95: if_icmpge +81 -> 176
    //   98: aload_0
    //   99: getfield 399	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   102: aconst_null
    //   103: invokevirtual 343	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   106: pop
    //   107: aload_0
    //   108: getfield 396	android/support/v4/app/FragmentManagerImpl:mAvailBackStackIndices	Ljava/util/ArrayList;
    //   111: ifnonnull +14 -> 125
    //   114: aload_0
    //   115: new 338	java/util/ArrayList
    //   118: dup
    //   119: invokespecial 339	java/util/ArrayList:<init>	()V
    //   122: putfield 396	android/support/v4/app/FragmentManagerImpl:mAvailBackStackIndices	Ljava/util/ArrayList;
    //   125: getstatic 111	android/support/v4/app/FragmentManagerImpl:DEBUG	Z
    //   128: ifeq +29 -> 157
    //   131: ldc 54
    //   133: new 167	java/lang/StringBuilder
    //   136: dup
    //   137: invokespecial 168	java/lang/StringBuilder:<init>	()V
    //   140: ldc_w 1300
    //   143: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   146: iload_3
    //   147: invokevirtual 404	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   150: invokevirtual 178	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   153: invokestatic 358	android/util/Log:v	(Ljava/lang/String;Ljava/lang/String;)I
    //   156: pop
    //   157: aload_0
    //   158: getfield 396	android/support/v4/app/FragmentManagerImpl:mAvailBackStackIndices	Ljava/util/ArrayList;
    //   161: iload_3
    //   162: invokestatic 681	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   165: invokevirtual 343	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   168: pop
    //   169: iload_3
    //   170: iconst_1
    //   171: iadd
    //   172: istore_3
    //   173: goto -80 -> 93
    //   176: getstatic 111	android/support/v4/app/FragmentManagerImpl:DEBUG	Z
    //   179: ifeq +39 -> 218
    //   182: ldc 54
    ...
    //   191: ldc_w 416
    //   194: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   197: iload_1
    //   198: invokevirtual 404	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   201: ldc_w 418
    //   204: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   207: aload_2
    //   208: invokevirtual 355	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   211: invokevirtual 178	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   214: invokestatic 358	android/util/Log:v	(Ljava/lang/String;Ljava/lang/String;)I
    //   217: pop
    //   218: aload_0
    //   219: getfield 399	android/support/v4/app/FragmentManagerImpl:mBackStackIndices	Ljava/util/ArrayList;
    //   222: aload_2
    //   223: invokevirtual 343	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   226: pop
    //   227: goto -137 -> 90
    //   230: astore_2
    //   231: aload_0
...
/* Location:              C:\playground\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\app\FragmentManagerImpl.class
