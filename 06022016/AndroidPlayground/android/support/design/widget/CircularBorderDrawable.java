  ...
  extends Drawable
{
  ...
  private Shader createGradientShader()
  {
    ...
    int i = ColorUtils.compositeColors(this.mTopOuterStrokeColor, this.mTintColor);
    int j = ColorUtils.compositeColors(this.mTopInnerStrokeColor, this.mTintColor);
    int k = ColorUtils.compositeColors(ColorUtils.setAlphaComponent(this.mTopInnerStrokeColor, 0), this.mTintColor);
    int m = ColorUtils.compositeColors(ColorUtils.setAlphaComponent(this.mBottomInnerStrokeColor, 0), this.mTintColor);
    int n = ColorUtils.compositeColors(this.mBottomInnerStrokeColor, this.mTintColor);
    int i1 = ColorUtils.compositeColors(this.mBottomOuterStrokeColor, this.mTintColor);
...
/* Location:              C:\playground\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\android\support\design\widget\CircularBorderDrawable.class
