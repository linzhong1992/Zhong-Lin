  ...
  extends LinearLayout
{
    ...
    extends HeaderBehavior<AppBarLayout>
  {
    ...
    private void snapToChildIfNeeded(CoordinatorLayout paramCoordinatorLayout, AppBarLayout paramAppBarLayout)
    {
      ...
      int i;
      if ((localView != null) && ((((AppBarLayout.LayoutParams)localView.getLayoutParams()).getScrollFlags() & 0x11) == 17))
      {
        i = -localView.getTop();
...
/* Location:              C:\playground\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\android\support\design\widget\AppBarLayout.class
