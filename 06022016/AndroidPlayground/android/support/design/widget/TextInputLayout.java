  ...
  extends LinearLayout
{
  ...
  private void addIndicator(TextView paramTextView, int paramInt, LinearLayout.LayoutParams paramLayoutParams)
  {
    ...
    this.mIndicatorArea.addView(paramTextView, paramInt, paramLayoutParams);
  }
  ...
  private void updateLabelVisibility(boolean paramBoolean)
  {
    ...
    label125:
    label130:
    for (int k = this.mFocusedTextColor.getDefaultColor();; k = this.mDefaultTextColor.getDefaultColor())
    {
      localCollapsingTextHelper.setCollapsedTextColor(k);
      if ((i == 0) && (!bool) && (j == 0)) {
        break label142;
      }
  ...
  public void setCounterEnabled(boolean paramBoolean)
  {
    if (this.mCounterEnabled != paramBoolean)
    {
      ...
      localLayoutParams.gravity = (localLayoutParams.gravity & 0x70 | 0x800005);
      ViewCompat.setAccessibilityLiveRegion(this.mCounterView, 1);
      addIndicator(this.mCounterView, -1, localLayoutParams);
      if (this.mEditText != null) {
        break label113;
      }
      updateCounter(0);
  ...
  public void setErrorEnabled(boolean paramBoolean)
  {
    if (this.mErrorEnabled != paramBoolean)
    {
      ...
      addIndicator(this.mErrorView, 0, localLayoutParams);
    }
    for (;;)
    {
...
/* Location:              C:\playground\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\android\support\design\widget\TextInputLayout.class
