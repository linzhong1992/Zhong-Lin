  ...
  extends HorizontalScrollView
{
    ...
    extends LinearLayout
  {
    ...
    void animateIndicatorToPosition(final int paramInt1, int paramInt2)
    {
      ...
      for (;;)
      {
        if ((i != k) || (j != m))
        {
          localObject = TabLayout.access$1702(TabLayout.this, ViewUtils.createAnimator());
          ...
          ((ValueAnimatorCompat)localObject).setListener(new ValueAnimatorCompat.AnimatorListenerAdapter()
          {
            ...
            {
              TabLayout.SlidingTabStrip.access$1902(TabLayout.SlidingTabStrip.this, paramInt1);
              TabLayout.SlidingTabStrip.access$2002(TabLayout.SlidingTabStrip.this, 0.0F);
            }
    ...
    protected void onMeasure(int paramInt1, int paramInt2)
    {
      ...
      do
      {
        ...
        TabLayout.access$1502(TabLayout.this, 0);
    ...
    implements View.OnLongClickListener
  {
    ...
    public void onMeasure(int paramInt1, int paramInt2)
    {
      ...
      if ((j > 0) && ((i == 0) || (i > j)))
      {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(TabLayout.this.mTabMaxWidth, Integer.MIN_VALUE), paramInt2);
...
/* Location:              C:\playground\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\android\support\design\widget\TabLayout.class
