  ...
  implements DrawerLayout.DrawerListener
{
  ...
  <T extends Drawable,  extends DrawerToggle> ActionBarDrawerToggle(Activity paramActivity, Toolbar paramToolbar, DrawerLayout paramDrawerLayout, T paramT, @StringRes int paramInt1, @StringRes int paramInt2)
  {
    ...
    label180:
    for (this.mSlider = new DrawerArrowDrawableToggle(paramActivity, this.mActivityImpl.getActionBarThemedContext());; this.mSlider = ((DrawerToggle)paramT))
    {
...
/* Location:              C:\playground\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\app\ActionBarDrawerToggle.class
