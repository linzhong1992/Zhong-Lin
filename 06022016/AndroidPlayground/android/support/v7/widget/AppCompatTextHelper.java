...
class AppCompatTextHelper
{
  ...
  void loadFromAttributes(AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    if (localTypedArray.hasValue(1))
    {
      ...
      this.mDrawableLeftTint.mTintList = ((TintManager)localObject).getTintList(localTypedArray.getResourceId(1, 0));
    }
    if (localTypedArray.hasValue(2))
    {
      this.mDrawableTopTint = new TintInfo();
      this.mDrawableTopTint.mHasTintList = true;
      this.mDrawableTopTint.mTintList = ((TintManager)localObject).getTintList(localTypedArray.getResourceId(2, 0));
    }
    if (localTypedArray.hasValue(3))
    {
      this.mDrawableRightTint = new TintInfo();
      this.mDrawableRightTint.mHasTintList = true;
      this.mDrawableRightTint.mTintList = ((TintManager)localObject).getTintList(localTypedArray.getResourceId(3, 0));
    }
    if (localTypedArray.hasValue(4))
    {
      this.mDrawableBottomTint = new TintInfo();
      this.mDrawableBottomTint.mHasTintList = true;
      this.mDrawableBottomTint.mTintList = ((TintManager)localObject).getTintList(localTypedArray.getResourceId(4, 0));
    }
...
/* Location:              C:\playground\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\AppCompatTextHelper.class
