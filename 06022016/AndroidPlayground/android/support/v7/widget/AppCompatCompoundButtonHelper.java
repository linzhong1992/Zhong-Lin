  ...
  void loadFromAttributes(AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    try
    {
      if (paramAttributeSet.hasValue(R.styleable.CompoundButton_android_button))
      {
        ...
        if (paramInt != 0) {
          this.mView.setButtonDrawable(this.mTintManager.getDrawable(paramInt));
        }
      }
...
/* Location:              C:\playground\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\AppCompatCompoundButtonHelper.class
