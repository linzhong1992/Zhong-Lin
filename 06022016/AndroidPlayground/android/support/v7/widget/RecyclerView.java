  ...
  implements ScrollingView, NestedScrollingChild
{
  ...
  private void animateChange(@NonNull ViewHolder paramViewHolder1, @NonNull ViewHolder paramViewHolder2, @NonNull RecyclerView.ItemAnimator.ItemHolderInfo paramItemHolderInfo1, @NonNull RecyclerView.ItemAnimator.ItemHolderInfo paramItemHolderInfo2)
  {
  ...
  {
    return (this.mItemAnimator == null) || (this.mItemAnimator.canReuseUpdatedViewHolder(paramViewHolder));
  }
  ...
  void dispatchLayout()
  {
    ...
    do
    {
      ...
      if ((this.mState.mRunSimpleAnimations) && (this.mItemsChanged))
      {
        ...
        State.access$2202(this.mState, this.mState.mRunPredictiveAnimations);
      ...
      if (this.mState.mRunPredictiveAnimations)
      {
        ...
        State.access$1902(this.mState, false);
        this.mLayout.onLayoutChildren(this.mRecycler, this.mState);
        State.access$1902(this.mState, bool);
        i = 0;
        ...
        this.mAdapterHelper.consumePostponedUpdates();
        this.mState.mItemCount = this.mAdapter.getItemCount();
        State.access$1802(this.mState, 0);
      ...
      for (;;)
      {
        ...
        break label599;
        l = getChangedHolderKey((ViewHolder)localObject);
        localItemHolderInfo = this.mItemAnimator.recordPostLayoutInformation(this.mState, (ViewHolder)localObject);
        ViewHolder localViewHolder = this.mViewInfoStore.getFromOldChangeHolders(l);
        if ((localViewHolder != null) && (!localViewHolder.shouldIgnore())) {
          animateChange(localViewHolder, (ViewHolder)localObject, this.mViewInfoStore.popFromPreLayout(localViewHolder), localItemHolderInfo);
        } else {
          this.mViewInfoStore.addToPostLayout((ViewHolder)localObject, localItemHolderInfo);
        }
      }
      this.mViewInfoStore.process(this.mViewInfoProcessCallback);
      resumeRequestLayout(false);
      this.mLayout.removeAndRecycleScrapInt(this.mRecycler);
      State.access$2602(this.mState, this.mState.mItemCount);
      this.mDataSetHasChangedAfterLayout = false;
      State.access$2302(this.mState, false);
      State.access$2102(this.mState, false);
      onExitLayoutOrScroll();
      LayoutManager.access$2402(this.mLayout, false);
  ...
  void initAdapterManager()
  {
    this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback()
    {
      ...
      public void offsetPositionsForRemovingInvisible(int paramAnonymousInt1, int paramAnonymousInt2)
      {
        ...
        RecyclerView.this.mItemsAddedOrRemoved = true;
        RecyclerView.State.access$1812(RecyclerView.this.mState, paramAnonymousInt2);
      }
    ...
    implements RecyclerView.ItemAnimator.ItemAnimatorListener
  {
    ...
    public void onAnimationFinished(RecyclerView.ViewHolder paramViewHolder)
    {
      ...
      if ((!RecyclerView.ViewHolder.access$6100(paramViewHolder)) && (!RecyclerView.this.removeAnimatingView(paramViewHolder.itemView)) && (paramViewHolder.isTmpDetached())) {
  ...
  public final class Recycler
  {
    ...
    RecyclerView.ViewHolder getScrapViewForPosition(int paramInt1, int paramInt2, boolean paramBoolean)
    {
      ...
      for (;;)
      {
        if (i < j)
        {
          ...
          if ((((RecyclerView.ViewHolder)localObject).wasReturnedFromScrap()) || (((RecyclerView.ViewHolder)localObject).getLayoutPosition() != paramInt1) || (((RecyclerView.ViewHolder)localObject).isInvalid()) || ((!RecyclerView.State.access$2200(RecyclerView.this.mState)) && (((RecyclerView.ViewHolder)localObject).isRemoved()))) {
            break label255;
          }
    ...
    View getViewForPosition(int paramInt, boolean paramBoolean)
    {
      ...
      if ((k != 0) && (!RecyclerView.this.mState.isPreLayout()) && (((RecyclerView.ViewHolder)localObject2).hasAnyOfTheFlags(8192)))
      {
        ...
        if (RecyclerView.State.access$2300(RecyclerView.this.mState))
        {
    ...
    {
      paramView = RecyclerView.getChildViewHolderInt(paramView);
      if ((!paramView.isUpdated()) || (paramView.isInvalid()) || (RecyclerView.this.canReuseUpdatedViewHolder(paramView)))
      {
    ...
    extends RecyclerView.AdapterDataObserver
  {
    ...
    public void onChanged()
    {
      ...
      if (RecyclerView.this.mAdapter.hasStableIds())
      {
        RecyclerView.State.access$1902(RecyclerView.this.mState, true);
  ...
  public static abstract class SmoothScroller
  {
    ...
    void start(RecyclerView paramRecyclerView, RecyclerView.LayoutManager paramLayoutManager)
    {
      ...
      RecyclerView.State.access$5602(this.mRecyclerView.mState, this.mTargetPosition);
      this.mRunning = true;
      this.mPendingInitialRun = true;
    ...
    protected final void stop()
    {
      ...
      onStop();
      RecyclerView.State.access$5602(this.mRecyclerView.mState, -1);
      this.mTargetView = null;
...
/* Location:              C:\playground\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\RecyclerView.class
