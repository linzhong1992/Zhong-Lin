  ...
  implements ThreadUtil<T>
{
  ...
  static class MessageQueue
  {
    ...
    MessageThreadUtil.SyncQueueItem next()
    {
      ...
      //   27: invokestatic 24	android/support/v7/util/MessageThreadUtil$SyncQueueItem:access$200	(Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;)Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;
    ...
    void sendMessage(MessageThreadUtil.SyncQueueItem paramSyncQueueItem)
    {
      ...
      //   21: astore_2
      //   22: aload_2
      //   23: invokestatic 24	android/support/v7/util/MessageThreadUtil$SyncQueueItem:access$200	(Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;)Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   26: ifnull +11 -> 37
      //   29: aload_2
      //   30: invokestatic 24	android/support/v7/util/MessageThreadUtil$SyncQueueItem:access$200	(Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;)Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   33: astore_2
      //   34: goto -12 -> 22
      //   37: aload_2
      //   38: aload_1
      //   39: invokestatic 37	android/support/v7/util/MessageThreadUtil$SyncQueueItem:access$202	(Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;)Landroid/support/v7/util/MessageThreadUtil$SyncQueueItem;
      //   42: pop
      //   43: goto -29 -> 14
      //   46: astore_1
      //   47: aload_0
...
/* Location:              C:\playground\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\util\MessageThreadUtil.class
